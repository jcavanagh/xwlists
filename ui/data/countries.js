...
//Transform to maps
//TODO: Make this static, or find another data source
// const countriesSelect = countries.map(c => ({
//     name: c,
//     value: c
// }));

const states = countries.reduce((all, country, index) => {
    all[country] = s_a[index + 1].split('|');
    return all;
}, {});

//States for react-select
// const statesSelect = countries.reduce((all, country, index) => {
//     all[country] = s_a[index].split('|').map(s => ({
//         name: s,
//         value: s
//     }));
//     return all;
